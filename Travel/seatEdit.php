                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav"><a class="nav-link" href="menu.php">MENU</a><a class="nav-link" href="seat.php">SEAT</a></nav>
                        </div>
                                    ...
                                    <?php  				
                                        ...
                                        while ( $d = mysqli_fetch_array($result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?=$d['quota'] ?></td>                                                                                                                                   
                                                <td>
                                                    <a href="seatDelete.php?id_wisata=<?= $d['id_seat'] ?>">Delete</a>
                                                </td>
                                                <td>
                                                <a href="seatEdit.php?id=<?php echo $d['id_seat']; ?>">EDIT</a>
                                                </td>
                                            </tr>
                                        <?php 
                                            } 
