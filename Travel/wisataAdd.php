            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">ADD Wisata</h1>
                    </div>
                    <div class="site-section bg-light">
                        <div class="container">
                            <div class="row">
                                ...
                                <form action="wisataInput.php" class="p-5 bg-white" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="lokasi" id="lokasi" cols="30" rows="2"
                                                    class="form-control" placeholder="Lokasi Tempat Wisata" required>
                            </textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row form-group">
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="keterangan" id="note" cols="30" rows="5"
                                                    class="form-control" placeholder="Catatan Pelapak">
                            </textarea>
                                            </div>
                                        </div>
