                    ...
                    <div class="site-section bg-light">
                        <div class="container">
                            <div class="row">
                                ...
                                ?>
                                    <form action="wisataUpdate.php" class="p-5 bg-white" method="POST">

                                        <div class="row form-group">
                                            <div class="col-md-12 mb-3 mb-md-0">
                                                <label class="text-black" for="fname">Nama</label>
                                                <input type="hidden" name="idw" value="<?= $id_wisata ?>">
                                                <input type="text" id="fname" class="form-control"
                                                    placeholder="Nama Wisata" name="nama" value="<?= $d['nama_wisata'] ?>">
                                            </div>
                                        </div>
