                    ...
                    <div class="site-section bg-light">
                        <div class="container">
                            <div class="row">
                                ...
                                <form action="bookingInputC.php" class="p-5 bg-white" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-md-12 mb-3 mb-md-0">
                                            <label class="text-black" for="">Tanggal </label> 
                                            <input type="date" id="datepicker1" min="<?=$date?>" class="form-control"  name="tanggal" required>
                                            </div>                                            
                                        </div>
                                        ...
                                        <?php 
                                        include "koneks.php";
                                        $query = "SELECT * FROM rencar ORDER BY nama_mobil";
                                        $result = mysqli_query($connect, $query);
                                        ?>

                                        <div class="form-group">
                                            <label for="rencar">Rencar</label>
                                            <br>
