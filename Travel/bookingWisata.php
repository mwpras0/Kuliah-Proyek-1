                    ...
                    <div class="site-section bg-light">
                        <div class="container">
                            <div class="row">
                                ...
                                <form action="bookingInputW.php" class="p-5 bg-white" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <input type="date" id="date" min="<?=$date?>" class="form-control" placeholder="Tanggal Pemesanan" name="tanggal" required>
                                            </div>                                            
                                        </div>
                                        ...
                                        <?php 
                                        include "koneks.php";
                                        $query = "select * from wisata order by nama_wisata";
