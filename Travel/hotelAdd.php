                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-7 mb-5">
                                    <form action="hotelInput.php" class="p-5 bg-white" enctype="multipart/form-data" method="post">

                                        <div class="row form-group">
                                            <div class="col-md-12 mb-3 mb-md-0">
                                                <label class="text-black" for="fname">Nama</label>
                                                <input type="text" id="fname" class="form-control"
                                                    placeholder="Nama Hotel" name="nama" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">                                            
                                            ...
                                            <textarea name="lokasi" class="form-control" id="exampleFormControlTextarea1" rows="3" name="pesan" required></textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group input-icon right">
                                                    <input type="file" class="form-control1" name="foto" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">                                            
                                            ...
                                            <textarea name="keterangan" class="form-control" id="exampleFormControlTextarea1" rows="3" name="pesan"></textarea>
                                        </div>
