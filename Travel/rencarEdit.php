            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Rencar</h1>
                    </div>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <?php 
                                    include "koneks.php";
                                    $id_mobil = $_GET['id'];
                                    $query = "SELECT * FROM rencar WHERE id_mobil = '$id_mobil'";
                                    $data = mysqli_query($connect, $query);
                                    while($d = mysqli_fetch_array($data)){
                                ?>
                                    <form action="rencarUpdate.php" class="p-5 bg-white">

                                        <div class="row form-group">
                                            <div class="col-md-12 mb-3 mb-md-0">
                                                <label class="text-black" for="fname">Nama</label>
                                                <input type="hidden" name="id" value="<?= $id_mobil ?>">
                                                <input type="text" id="fname" class="form-control"
                                                    placeholder="Nama" name="nama" value="<?= $d['nama_mobil'] ?>">
                                            </div>
                                        </div>
