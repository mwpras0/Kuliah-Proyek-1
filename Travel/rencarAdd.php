            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">ADD Mobil</h1>
                    </div>
                    <div class="site-section bg-light">
                        <div class="container">
                            <div class="row">
                                ...
                                <form action="rencarInput.php" class="p-5 bg-white" enctype="multipart/form-data" method="post">

                                        <div class="row form-group">
                                            <div class="col-md-12 mb-3 mb-md-0">
                                                <label class="text-black" for="fname">Nama</label>
                                                <input type="text" id="fname" class="form-control"
                                                    placeholder="Nama Mobil" name="nama" required>
                                            </div>
                                        </div>
